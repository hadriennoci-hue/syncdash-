...
const LAPTOP_LABEL_MAPS: Record<string, Record<string, string>> = {
  ...
  fr: { // [✓] fr-fr / fr-be — verified from store.acer.com/fr-fr (NX.J7WEF.00G)
    "taille d'écran":                'screen_size',
    "taille de l'écran":             'screen_size',
    'résolution maximale':           'resolution',
    'résolution':                    'resolution',
    'résolution native':             'resolution',
    "technologie d'écran":           'panel_type',
    'type de panneau':               'panel_type',
    "type d'écran":                  'panel_type',
    'taux de rafraîchissement':      'refresh_rate',
    'fréquence de rafraîchissement': 'refresh_rate',
    // "Processeur" row has brand only — use specific fields
    'type de processeur':            'processor_model',
    'modèle de processeur':          'processor_model',
    'fabricant du processeur':       'processor_brand',
    'marque du processeur':          'processor_brand',
    "système d'exploitation":        'operating_system',
    'écran tactile':                 'touchscreen',
    'écran multi-touch':             'touchscreen',
    'mémoire standard':              'ram',
    'mémoire ram':                   'ram',
    'ram':                           'ram',
    'capacité totale du disque ssd': 'storage',
    'stockage':                      'storage',
  ...
  de: { // [✓] de-de — German (monitor-verified; laptop labels follow same Magento 2 pattern)
    'bildschirmdiagonale':           'screen_size',
    'bildschirmgröße':               'screen_size',
    'maximale auflösung':            'resolution',
    'bildschirmtechnologie':         'panel_type',
    'panel-technologie':             'panel_type',
    'bildwiederholungsrate':         'refresh_rate',
    // "Prozessor" row has brand only — use specific fields
    'prozessortyp':                  'processor_model',
    'prozessormodell':               'processor_model',
    'prozessorhersteller':           'processor_brand',
    'prozessormarke':                'processor_brand',
    'betriebssystem':                'operating_system',
    'touchscreen':                   'touchscreen',
    'multi-touch-bildschirm':        'touchscreen',
    'standardspeicher':              'ram',
    'arbeitsspeicher':               'ram',
    'ram':                           'ram',
    'gesamte ssd-kapazität':         'storage',
  ...
  es: { // es-es — verified from store.acer.com/es-es (NX.J02EB.002)
    'tamaño de pantalla':            'screen_size',
    'diagonal de pantalla':          'screen_size',
    'resolución máx.':               'resolution',
    'resolución máxima':             'resolution',
    'tecnología de pantalla':        'panel_type',
    'tecnología del panel':          'panel_type',
    'frecuencia de actualización':   'refresh_rate',
    // Processor: "Procesador" row value is brand only ("Intel®") — use specific fields instead
    'fabricante de procesador':      'processor_brand',
    'marca del procesador':          'processor_brand',
    'tipo de procesador':            'processor_model',
    'sistema operativo':             'operating_system',
    'pantalla táctil':               'touchscreen',
    'pantalla multitáctil':          'touchscreen',
    'memoria estándar':              'ram',
    'memoria ram':                   'ram',
    'ram':                           'ram',
    'capacidad total de ssd':        'storage',
  ...
  it: { // it-it — verified from store.acer.com/it-it (NX.JCJET.001)
    'dimensione dello schermo':      'screen_size',
    'diagonale schermo':             'screen_size',
    'risoluzione massima':           'resolution',
    'tecnologia visualizzazione a schermo': 'panel_type',
    'tecnologia del pannello':       'panel_type',
    'frequenza di aggiornamento':    'refresh_rate',
    // "Processore" row has brand only — use specific fields
    'tipo processore':               'processor_model',
    'produttore processore':         'processor_brand',
    'marca del processore':          'processor_brand',
    'sistema operativo':             'operating_system',
    'touchscreen':                   'touchscreen',
    'schermo multi-touch':           'touchscreen',
    'memoria standard':              'ram',
    'memoria ram':                   'ram',
    'ram':                           'ram',
