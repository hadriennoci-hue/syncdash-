...
export const ATTRIBUTE_OPTIONS: Record<AttributeCollection, AttributeOptionsMap> = {
  laptops: {
    ...
    series: ['Aspire', 'Swift', 'Nitro', 'Helios', 'Triton', 'TM', 'Extensa', 'Chromebook'],
    ...
    screen_type: ['IPS', 'OLED', 'Mini LED', 'TN'],
    refresh_rate: ['60', '90', '120', '144', '165', '240'],
    touchscreen: ['No', 'Yes'],
    processor_brand: ['Intel', 'AMD', 'Qualcomm', 'MediaTek'],
    processor_model: ['Core i5', 'Core i7', 'Core i9', 'Core U5', 'Core U7', 'Core U9', 'AMD Ryzen 5', 'AMD Ryzen 7', 'AMD Ryzen 9', 'SD X Elite'],
    processor_generation: ['10th Gen', '12th Gen', '13th Gen', '14th Gen', 'Core U S1', 'Core U S2', 'Ryzen 7000', 'Ryzen 8000', 'Ryzen 9000', 'N-Series', 'Kompanio Ultra', 'Ryzen AI 300'],
    processor_cores: ['6', '8', '10', '12', '14', '16', '24'],
    gpu_brand: ['NVIDIA', 'AMD', 'Intel', 'ARM'],
  ...
  monitor: {
    ...
    series: ['Nitro', 'Acer CB', 'Predator XB', 'Predator X', 'EK1', 'SA2'],
